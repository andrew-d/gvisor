...
type Mount struct {
	...
	// umounted is true if the umount process has been initiated on this Mount.
	// VirtualFilesystem does not hold a reference on Mounts for which umounted
	// is true. umounted is protected by VirtualFilesystem.mountMu.
	umounted bool
